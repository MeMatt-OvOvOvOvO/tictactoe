    ...
    private void action(ImageView imageView, int selectedPositions){
        ...
        if(turn == 1){
            ...
            if(playerWin()){
                ...
                myDialog winDialog = new myDialog(offlineActivity.this, "Player 1 has won the match", offlineActivity.this);
                winDialog.setCancelable(false);
                winDialog.show();
            }
            else if(selectedBoxes == 9){
                myDialog winDialog = new myDialog(offlineActivity.this, "Result: draw", offlineActivity.this);
                winDialog.setCancelable(false);
                winDialog.show();
            }
            else{
            ...
            if(playerWin()){
                myDialog winDialog = new myDialog(offlineActivity.this, "Player 2 has won the match", offlineActivity.this);
                winDialog.setCancelable(false);
                winDialog.show();
            }
            else if(selectedBoxes == 9){
